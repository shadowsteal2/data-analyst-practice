...
**Herramientas:** SQL · Python (Pandas, Matplotlib) · Power BI
...
* **Estacionalidad:** Se observa un pico de ventas recurrente en los meses de...

## Metodología y Flujo de Trabajo

1. **Extracción (SQL):** Consultas a la base de datos SQLite para obtener KPIs de facturación por país, género, artista y evolución temporal. *(Ver `/sql`)*
...
!\[Vista previa del Dashboard de Power BI](ruta-a-tu-imagen.png)

## Estructura del Repositorio

* `/sql`: Consultas comentadas resolviendo las preguntas de negocio.
* `/python`: Scripts de análisis exploratorio y generación del dataset final.
* `/powerbi`: Archivo `.pbix` y versión en PDF del cuadro de mando.
